<h2><a href="https://leetcode.com/problems/can-make-arithmetic-progression-from-sequence">1950. Sign of the Product of an Array</a></h2><h3>Easy</h3><hr><p>Implement a function <code>signFunc(x)</code> that returns:</p>
